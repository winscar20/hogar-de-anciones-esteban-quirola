...
class InformeMedicoController extends Controller
{
    ...
    {
        $informe = InformeMedico::findOrFail($id);
        ...
        return redirect()->route('informes-medicos.index')->with('success', 'Informe Médico actualizada correctamente');
    }
    ...
    public function edit(string $id)
    {
        ...
        return Inertia::render('InformeMedico/Edit', [
            'informe' => $informe_medico
        ]);
    }
