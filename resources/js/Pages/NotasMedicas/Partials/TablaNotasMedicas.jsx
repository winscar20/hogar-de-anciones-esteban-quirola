...
const TablaNotasMedicas = ({ notas, filters }) => {
    ...
    const handleDelete = (id) => {
        if (confirm("¿Estás seguro de que deseas eliminar esta nota médica?")) {
            router.delete(route("notas-medicas.destroy", id), {
                preserveScroll: true,
                onSuccess: () => {
                    if (flash?.success) {
                        ...
                        >
                            ...
                            {(hasPermission(
                                ...
                                <div className="flex justify-end mt-4 space-x-4 text-gray-400">
                                    Solo Doctores pueden editar o eliminar las
                                    notas medicas.
                                </div>
                            )}
                        </div>
...
export default TablaNotasMedicas;
