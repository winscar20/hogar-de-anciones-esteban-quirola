...
import TablaInformesMedicos from "./Partials/TablaInformesMedicos";
    ...
    useEffect(() => {
        if (
            ...
            const handler = setTimeout(() => {
                router.get(
                    route("informes-medicos.index"),
                    { search: searchQuery, page: informes.current_page || 1 },
                    { preserveState: true }
                );
            }, 500);
                ...
                <div className="overflow-x-auto bg-white p-4 max-w-screen-xl mx-auto rounded-lg">
                    ...
                    {hasPermission(
                        ...
                        <div className="relative m-[6px] mb-3 float-right hidden sm:block">
                            <Link
                                href={route("informes-medicos.create")}
                                className="
                                    px-4
                                    py-3
                                    rounded-full
